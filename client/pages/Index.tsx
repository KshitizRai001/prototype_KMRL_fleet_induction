          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <div className="mt-6 flex flex-wrap items-center gap-3">
                <Button asChild>
                  <a href="/simulate">
                    <PlayCircle className="h-4 w-4" /> Run what‑if
                  </a>
                </Button>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <Card>
                ...
                <CardContent className="text-sm text-muted-foreground">
                  Backed by automated FC and job‑card gating
                </CardContent>
              </Card>
              <Card>
                <CardHeader className="pb-2">
                ...
                <CardContent className="text-sm text-muted-foreground">
                  Scales to multiple depots by 2027
                </CardContent>
              </Card>
              <Card>
                <CardHeader className="pb-2">
                ...
                <CardContent className="text-sm text-muted-foreground">
                  Automated within the nightly operating window
                </CardContent>
              </Card>
              <Card>
                <CardHeader className="pb-2">
                ...
                <CardContent className="text-sm text-muted-foreground">
                  Meets advertiser hour commitments
                </CardContent>
              </Card>
            </div>
          </div>
